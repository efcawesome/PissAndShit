...
namespace PissAndShit.Projectiles
{
    public class YoungDukeSharknadoBolt : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Vector2 spinningpoint2 = Vector2.Normalize(projectile.velocity) * new Vector2(projectile.width / 2f, projectile.height) * 0.75f;
            ...
            if (projectile.owner == Main.myPlayer)
            {
                if (projectile.ai[1] < 1f)
                {
                    ...
                    int num256 = Projectile.NewProjectile(projectile.Center.X - projectile.direction * 30, projectile.Center.Y - 4f, -projectile.direction * 0.01f, 0f, ProjectileType<YoungDukeSharknado>(), num255, 4f, projectile.owner, 16f, 15f);
