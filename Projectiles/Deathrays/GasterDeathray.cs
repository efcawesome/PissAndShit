...
{
    class GasterDeathray : BaseDeathray
    {
        ...
        public override void SetStaticDefaults() => DisplayName.SetDefault("GasterLaser");
        public override void SetDefaults() { projectile.hide = true; projectile.hostile = true; }
